...
namespace FerryConverter
{
    public static class TrainToMetro
    {
        ...
        {
//            long id;
//            if (!Util.TryGetWorkshopId(info, out id) || !Ships.GetConvertedIds(ShipCategory.Trains).Contains(id))
//            {
//                return false;
//            }
...
//
//            TrainConversions.CustomConversions(info, id, ShipCategory.Trains);
