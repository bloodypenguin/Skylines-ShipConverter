...
namespace FerryConverter
{
    public static class TrainStationToMetroStation
    {
        ...
        {
//            long id;
//            if (!Util.TryGetWorkshopId(info, out id) || !Stations.GetConvertedIds(HarborCategory.All).Contains(id))
//            {
//                return false;
//            }
...
//                return true;
//            }
//            var nameConverter = Stations.GetCategory(id) == HarborCategory.Old ? new Func<string, string>(s => "Steel " + s) : (s => s);
